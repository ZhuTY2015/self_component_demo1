<template>
  <div>
    <p style="padding:10px 0;">基础表单弹窗</p>
    <el-row :gutter="20" style="background: #FFFFFF;padding: 10px;">
      <el-col :span="14">
        <div class="scroll-box">

          <el-button type="primary" @click="bindShow">新增</el-button>
...
<script>
  ...
  import {dialogContent} from "./formDialogContent";
